---
title: Mark Text
description: “一款所见即所得的Markdown编辑器，内置多种主题可自由切换，最大的亮点是支持斗图，快捷键就可以打开表情包搜索。”
version: V 0.15.1
category: markdown
tags: ["markdown"]
downloadUrl: https://github.com/marktext/marktext/releases/download/v0.15.1/marktext-0.15.1.dmg
