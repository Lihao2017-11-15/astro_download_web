---
title: 赤友 NTFS for Mac
description: “是一款 Mac 读写 NTFS 移动硬盘 / U 盘的国产工具，支持快速读写NTFS磁盘，凭借极高的性价比、易用的操作，获得了众多用户的青睐。全新3.0版原价36元，限时特价20元。”
version: V3.0
category: NTFS挂载
tags: ["NTFS挂载"]
downloadUrl: https://store.lizhi.io/site/products/id/68?cid=enqvaglc
...
· 支持快速读写NTFS磁盘，轻松传输、拷贝、编辑文件
· 支持快捷磁盘管理，标签、格式化、磁盘重命名等
· 支持读写Bootcamp分区
· 支持最新 macOS 11 (Big Sur)
